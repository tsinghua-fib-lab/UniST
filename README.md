...
📢: **News** (2024.10) We are excited to introduce [UniFlow](https://arxiv.org/abs/2411.12972) ([Github](https://github.com/YuanYuan98/UniFlow)), a significant enhancement to our UniST framework! It seamlessly handles both **grid-based** data and **graph-based** data simultaneously, unlocking greater universalty. 
